...
const menuData = [
  ...
  // },
    ...
    },
    {
      path: '/group',
      key: 'GROUP',
      icon: <Link to='/group'><TeamOutlined /></Link>,
      label: 'Nhóm người dùng',
      permission: 'GROUP',
      description: 'GROUP',
    },
    {
      path: '/permission',
      key: 'PERMISSION',
      icon: <Link to='/permission'><BuildOutlined /></Link>,
      label: 'Quyền',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    {
      path: '/site',
      key: 'SITE',
      icon: <Link to='/site'><AimOutlined /></Link>,
      label: 'Địa danh',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    {
      path: '/hotel',
      key: 'HOTEL',
      icon: <Link to='/hotel'><HomeOutlined /></Link>,
      label: 'Khách sạn',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    {
      path: '/room',
      key: 'ROOM',
      icon: <Link to='/room'><HomeOutlined /></Link>,
      label: 'Phòng',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    {
      path: '/order',
      key: 'ORDER',
      icon: <Link to='/order'><ShoppingCartOutlined /></Link>,
      label: 'Đơn đặt',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    ...
    // },
    {
      path: '/calendar',
      key: 'CALENDAR',
      icon: <Link to='/calendar'><ScheduleOutlined /></Link>,
      label: 'Lịch trình',
      permission: 'CALENDAR',
    ...
    },
    {
      path: '/price',
      key: 'PRICE',
      icon: <Link to='/price'><DollarOutlined /></Link>,
      label: 'Quản lý giá',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
    {
      path: '/rating',
      key: 'RATING',
      icon: <Link to='/rating'><StarOutlined /></Link>,
      label: 'Đánh giá',
      permission: 'DASHBOARD',
      description: 'DASHBOARD',
    },
